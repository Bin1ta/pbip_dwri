...
class BaseController extends Controller
{
    public function __construct()
    {
        ...
        $header = OfficeSetting::with('chief', 'chief.designation','grievanceOfficer','grievanceOfficer.designation', 'informationOfficer', 'informationOfficer.designation')->latest()->first();

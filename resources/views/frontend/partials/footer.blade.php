...
<footer class="footer mt-2" style="background-color: {{ $colors->scroller }}">
            ...
            <div class="row">
                <div class="col-sm-2 col-md-2 col-lg-2">
                    ...
                    <ul class="list mt-2">
                        ...
                        <li class="text-white">
                            <i class="fa fa-phone"></i> @if(request()->language=='en')
                              {{Helpers::getEnglishNumber($header->office_phone ?? '')}}
                            @else
                               {{Helpers::getNepaliNumber($header->office_phone ?? '')}}
                            @endif
                        </li>
                        <li class="text-white">
                    ...
                    <div class="home-contact-card">
                        <ul>
                            @foreach ($sharedLinks as $link)
                                <li>
                                    <a >
                                        <h6 class="text-bold" style="font-family: 'Kalimati', sans-serif;">
    ...
    <div class="footer-copyright" style="background-color: {{ $colors->footer }}">
        ...
        <span>Last Updated:  @if(request()->language=='en')
               {{Helpers::getEnglishNumber(config('app.date'))}}
            @else
               {{Helpers::getNepaliNumber(config('app.date'))}}
            @endif</span>
        <span>Visitors:@if(request()->language=='en')
                {{Helpers::getEnglishNumber($totalVisitors)}}
            @else
                {{Helpers::getNepaliNumber($totalVisitors)}}
            @endif </span>
        <span>Developed By:

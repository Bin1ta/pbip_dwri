    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            <li class="nav-item nav-item-has-children">
                <a
                    href="#"
                    class="{{request()->is('admin/forest/*') ? '' : 'collapsed'}}"
                    data-bs-toggle="collapse"
                    data-bs-target="#forest"
                    aria-controls="forest"
                    aria-expanded="{{request()->is('admin/forest/*')}}"
                    aria-label="Toggle navigation"
                >
              <span class="icon">
               <i class="mdi mdi-image-search-outline"></i>
                ...
                <ul id="forest"
                    class="collapse dropdown-nav {{request()->is('admin/forest/*') ? 'show' : ''}}">
                    <li>

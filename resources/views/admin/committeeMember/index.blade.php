                ...
                <div class="breadcrumb-wrapper mb-30">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.committeeMember.index') }}">Committee Member</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="row">
        ...
        @foreach ($committeeMembers as $member)
            <tr>
                ...
                <td>
                    <div class="action">
                        <a href="{{ route('admin.committeeMember.edit', $committeeMembers) }}" class="text-info">
                            <i class="lni lni-pencil"></i>
                        </a>
                        <form action="{{ route('admin.committeeMember.destroy', $committeeMembers) }}" method="POST" style="display: inline-block;">
                            @csrf
                            @method('DELETE')

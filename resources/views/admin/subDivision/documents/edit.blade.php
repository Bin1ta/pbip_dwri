                ...
                <div class="card-style mb-30">
                    ...
                    <form action="{{route('admin.subDivisionDocument.update',$subDivisionDocument)}}" method="POST"
                        ...
                        <div class="input-style-1">
                            ...
                            <select name="sub_division_document_category_id" id="sub_division_document_category_id"
                                    class="form-control">
                                <option value="">Select</option>
                                @foreach($subDivisionDocumentCategories as $subDivisionDocumentCategory)
                                    <option
                                        value="{{$subDivisionDocumentCategory->id}}" {{old('sub_division_document_category_id',$subDivisionDocumentCategory->id) == $subDivisionDocument->sub_division_document_category_id ? 'selected':''}}>{{$subDivisionDocumentCategory->title}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="file" class="@error('files') is-invalid @enderror" name="files[]" id="files"
                                   multiple>
                            @error('files.*')
                            <p style="color: red"> {{$message}}</p>
                            @enderror
                        ...
                        @if(config('default.dual_language'))
                            <div class="input-style-1">
                                ...
                                <input type="text" id="publisher_en" name="publisher_en"
                                       class="@error('publisher_en',$subDivisionDocument->publisher_en) is-invalid @enderror"
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="text" id="date" name="date" class="@error('date') is-invalid @enderror nepali-date"
                        ...
                        <div class="input-style-1">
                            ...
                            <textarea name="description" id="description" cols="30" rows="10"
                                      class="form-control">{{old('description',$subDivisionDocument->description)}}</textarea>
                            @error('description')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                        ...
                        @if(config('default.dual_language'))
                            <div class="input-style-1">
                                ...
                                <textarea name="description_en" id="description_en" cols="30" rows="10"
                                          class="form-control">{{old('description_en',$subDivisionDocument->description_en)}}</textarea>

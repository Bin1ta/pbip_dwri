    ...
    <div class="card-style mb-30">
        <form action="{{route('admin.officeSetting.update',$officeSetting)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="input-style-1">
                        <label for="cover_photo">Background Image</label>
                        <span>
                ...
                <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                    <div class="input-style-1">
                        <label for="grievance_officer_id">गुनासो सुन्ने अधिकारी</label>
                        <select name="grievance_officer_id" id="grievance_officer_id" class="form-control">
                            <option value="">- - छान्नुहोस् - -</option>
                            @foreach($employees as $employee)
                                <option value="{{$employee->id}}" {{$officeSetting->grievance_officer_id==$employee->id ? 'selected' : ''}}>{{$employee->name}}</option>
                            @endforeach
                        </select>
                        @error('grievance_officer_id')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                </div>

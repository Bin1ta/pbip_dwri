...
@section('content')
    ...
    <div class="card-style mb-30">
        <form action="{{route('admin.lawsuit.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
            <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="type" name="type"
                               placeholder="मुद्दाको किसिम" value="{{old('type')}}">
                        @error('type')
                    ...
                    <div class="col-md-6">
                        <div class="input-style-1">
                            ...
                            <input type="text" id="type_en" name="type_en"
                                   placeholder="मुद्दाको किसिम (English)" value="{{old('type_en')}}">
                            @error('type_en')
                            <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="bigo" name="bigo"
                               placeholder="बिगो" value="{{old('bigo')}}">
                        @error('bigo')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="input-style-1">
                            ...
                            <input type="text" id="bigo_en" name="bigo_en"
                                   placeholder="बिगो (English)" value="{{old('bigo_en')}}">
                            @error('bigo_en')
                            <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="fine" name="fine"
                               placeholder="जरिवाना" value="{{old('fine')}}">
                        @error('fine')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="jailed" name="jailed"
                               placeholder="कैद" value="{{old('jailed')}}">
                        @error('jailed')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="reg_date" name="reg_date"
                               placeholder="दर्ता मिति" value="{{old('reg_date')}}">
                        @error('reg_date')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="reg_body" name="reg_body"
                               placeholder="दर्ता भएको निकाय" value="{{old('reg_body')}}">
                        @error('reg_body')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>

...
@section('content')
    ...
    <div class="card-style mb-30">
        <form action="{{route('admin.forestCategory.store')}}" method="POST"
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-style mb-30">
                <h6 class="mb-10">Forest Category List</h6>
                    ...
                    <table class="table">
                        ...
                        @foreach($forestCategories as $forestCategory)
                            <tr>
                                ...
                                <td class="min-width">
                                    <p>{{$forestCategory->title}}</p>
                                </td>


                                <td>
                                    <div class="action">
                                        <a href="{{route('admin.forestCategory.edit', $forestCategory)}}" class="text-info">
                                            <i class="lni lni-pencil"></i>
                                        </a>
                                        <form action="{{route('admin.forestCategory.destroy',$forestCategory)}}" method="POST">
                                            @csrf
                                            @method('DELETE')

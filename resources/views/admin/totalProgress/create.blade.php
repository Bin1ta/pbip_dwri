...
@section('content')
    ...
    <div class="card-style mb-30">
        <form action="{{ route('admin.total-progress.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="financial_progress_periodic" name="financial_progress_periodic" placeholder="financial_progress_periodic name"
                            value="{{ old('financial_progress_periodic') }}">
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="financial_progress_cumulative" name="financial_progress_cumulative" placeholder="Financial progress cumulative"
                            value="{{ old('financial_progress_cumulative') }}">
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="financial_progress_rs" name="financial_progress_rs" placeholder="Rs.123****"
                            value="{{ old('financial_progress_rs') }}">
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="periodic_percentage"  name="periodic_percentage"
                            placeholder="Enter number" value="{{ old('periodic_percentage') }}">
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="yearly_percentage"  name="yearly_percentage"
                            placeholder="yearly percentage" value="{{ old('yearly_percentage') }}">
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="periodic_physical_progress"  name="periodic_physical_progress"
                            placeholder="periodic physical progress " value="{{ old('periodic_physical_progress') }}">
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="periodic_physical_cumulative"  name="periodic physical cumulative"
                            placeholder="periodic physical progress " value="{{ old('periodic_physical_cumulative') }}">
                ...
                <div class="col-md-12">
                    <div class="input-style-1">
                        ...
                        <textarea name="remarks" id="remarks" cols="30" rows="4" placeholder="remarks">{{ old('remarks') }}</textarea>
                        @error('remarks')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>

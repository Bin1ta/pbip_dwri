                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="invoice_no" name="invoice_no"
                               placeholder=" चलानी.नं. * " value="{{old('invoice_no')}}">
                        @error('invoice_no')
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="letter_count" name="letter_count"
                               placeholder="पत्र संख्या " value="{{old('letter_count')}}">
                        @error('letter_count')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="rec_name" name="rec_name"
                               placeholder="पत्र पाउने व्यक्ति वा कार्यालयको नाम, ठेगाना * " value="{{old('rec_name')}}">
                        @error('rec_name')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="deliver_type" name="deliver_type"
                               placeholder="पठाएको साधन" value="{{old('deliver_type')}}">
                        @error('deliver_type')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>

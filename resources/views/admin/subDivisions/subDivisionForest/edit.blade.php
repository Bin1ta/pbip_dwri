...
@section('content')
                ...
                <div class="breadcrumb-wrapper mb-30">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{route('admin.subDivision.forestDetail.index',$subDivision)}}">
                                    Forest Detail List
                                </a>
                            </li>
    ...
    <div class="card-style mb-30">
        <form action="{{route('admin.subDivision.forestDetail.update',[$subDivision,$forestDetail])}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="remarks" name="remarks"
                               placeholder="कैफियत" value="{{old('remarks',$forestDetail->remarks)}}">
                        @error('remarks')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="remarks_en" name="remarks_en"
                               placeholder="कैफियत (English)" value="{{old('remarks_en',$forestDetail->remarks_en)}}">
                        @error('remarks_en')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>

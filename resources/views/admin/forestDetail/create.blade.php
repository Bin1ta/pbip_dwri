                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <select name="forest_category_id" id="forest_category_id" class="form-control">
                            ...
                            @foreach($forestCategories as $forestCategory)
                                <option value="{{$forestCategory->id}}" {{old('forest_category_id')==$forestCategory->id ? 'selected':''}}>{{$forestCategory->title}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="input-style-1">
                        ...
                        <input type="text" id="forest_name" name="forest_name"
                               placeholder="सामुदायिक वनको नाम" value="{{old('forest_name')}}">
                        @error('forest_name')
                    ...
                    <div class="col-md-6">
                        <div class="input-style-1">
                            ...
                            <input type="text" id="forest_name_en" name="forest_name_en"
                                   placeholder="सामुदायिक वनको नाम (English)" value="{{old('forest_name_en')}}">
                    ...
                    <div class="col-md-6">
                        <div class="input-style-1">
                            ...
                            <input type="text" id="address_en" name="address_en"
                                   placeholder="ठेगाना (English)" value="{{old('address_en')}}">
                            @error('address_en')
                            <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="house_hold" name="house_hold"
                               placeholder="घरधुरी संख्या" value="{{old('house_hold')}}">
                        @error('house_hold')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="area" name="area"
                               placeholder="क्षेत्रफल (हेक्टरमा)" value="{{old('area')}}">
                        @error('area')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="approve_date" name="approve_date"
                               placeholder="कार्ययोजना स्विकृत् मिति" value="{{old('approve_date')}}">
                        @error('approve_date')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="end_date" name="end_date"
                               placeholder="कार्ययोजना समाप्त मिति" value="{{old('end_date')}}">
                        @error('end_date')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>

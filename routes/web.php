...
class listing
{
    public function routes()
    {
        ...
        Route::get('forestCategory/{forestCategory:slug}', [FrontendController::class, 'forestCategory'])->name('forestCategory');
        ...
        Route::get('/committee-member/{committeeMember}', [FrontendController::class, 'comitteeMember'])->name('committeeMember');
